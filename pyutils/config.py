...
class ConfigMeta(type):
    ...
    def __new__(mcls, name, bases, cls_attrs, config_filename='prod.ini', config_directory=config_dir):
        ...
        for section_name in config.sections():
            ...
            Section = SectionType(class_name,
                                  (object,),
...
if __name__ == '__main__':
    test_config_script = base_dir / 'create_confidurations.py'
    runpy.run_path(test_config_script)
    ...
    class ProdConfig(metaclass=ConfigMeta,
                     config_filename='prod.json'):
        pass

    print(ProdConfig.server.port)
    help(ProdConfig)
