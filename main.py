...
dataloaders = orchestrator.run_job(job_name="load_tsp_dataset",
...
model = TSPGNN(node_dim=Configs.model.get("node_dim", cast=int),
...
model_dict = orchestrator.run_job('load_model',
                                   path=model_path,
                                   device=device,
...
results = orchestrator.run_job('get_predictions',
                               model=model,
                               data=test_set,
