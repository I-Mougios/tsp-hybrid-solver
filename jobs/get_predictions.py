    ...
    def run(self):
        ...
        for batch in self.data:
            for i in range(len(batch)):
                ...
                predicted_optimal_tour = beamsearch(probabilities=probabilities,
                ...
                cost_of_predicted_tour = calculate_tour_cost(distances=distances,
                                                             tour=predicted_optimal_tour)
            
                cost_of_optimal_tour = calculate_tour_cost(distances=distances,
                                                           tour=graph.optimal_tour)
