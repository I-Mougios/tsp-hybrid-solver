...
3.   job_name method is a utility method to be shared across all jobs. It returns the module_name e.g. jobs.load_tsp_dataset -> load_tsp_dataset
"""
class BaseJob(ABC):
...
# print(BaseJob.__module__) # returns __main__ if this script is the entrypoint or jobs.base_job if imported
